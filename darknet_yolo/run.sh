...
#./darknet detector demo cfg/coco.data cfg/yolov2-tiny.cfg backup/old/yolov2-tiny_40000.weights /home/server/Downloads/2.mp4
...
./darknet detector demo cfg/coco.data cfg/yolov2-tiny.cfg yolov2-tiny.weights rtsp://210.119.85.77:1554/video1 -i 0
